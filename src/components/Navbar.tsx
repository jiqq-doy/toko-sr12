      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-between items-center py-3 md:py-4 gap-4 lg:gap-8">
          ...
          <div className="hidden md:flex items-center space-x-1 lg:space-x-2">
            <Link 
              to="/" 
              className={`px-4 py-2 rounded-full text-sm font-medium transition-colors ${isActive('/') ? 'bg-sr12-lightPink text-sr12-burgundy' : 'text-sr12-burgundy/80 hover:text-sr12-burgundy hover:bg-sr12-lightPink/50'}`}
            >
              Beranda
            </Link>
            <Link 
              to="/produk" 
              className={`px-4 py-2 rounded-full text-sm font-medium transition-colors ${isActive('/produk') ? 'bg-sr12-lightPink text-sr12-burgundy' : 'text-sr12-burgundy/80 hover:text-sr12-burgundy hover:bg-sr12-lightPink/50'}`}
            >
              Produk
            </Link>
            <Link 
              to="/tentang" 
              className={`px-4 py-2 rounded-full text-sm font-medium transition-colors ${isActive('/tentang') ? 'bg-sr12-lightPink text-sr12-burgundy' : 'text-sr12-burgundy/80 hover:text-sr12-burgundy hover:bg-sr12-lightPink/50'}`}
            >
              Tentang Kami
            </Link>
            <Link 
              to="/kontak" 
              className={`px-4 py-2 rounded-full text-sm font-medium transition-colors ${isActive('/kontak') ? 'bg-sr12-lightPink text-sr12-burgundy' : 'text-sr12-burgundy/80 hover:text-sr12-burgundy hover:bg-sr12-lightPink/50'}`}
            >
              Kontak
            </Link>
          </div>
