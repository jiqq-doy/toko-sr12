...
def analyze_products():
    ...
    for block in blocks[1:]:
        ...
        is_missing_b = b_val == "" or b_val == "Merawat dan menutrisi secara optimal."
        is_missing_i = i_val == "" or i_val == "Bahan alami pilihan."
        is_missing_h = h_val == "" or h_val == "Gunakan sesuai petunjuk pada kemasan."
